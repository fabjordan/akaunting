...
class Contact extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['company_id', 'type', 'name', 'document', 'email', 'company_name', 'fantasy_name', 'user_id', 'tax_number', 'phone', 'address', 'website', 'currency_code', 'reference', 'enabled'];
